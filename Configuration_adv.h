 ...
 *
 *
 * *Taken fromn pins_BTT_OCTOPUS_V1_common.h
 * 
...
#define SENSORLESS_BACKOFF_MM  { 3, 2, 0 }  // (mm) Backoff from endstops before sensorless homing
 ...
 *
 */
// KH: Disabled babystepping cuz printer runs headless
// #define BABYSTEPPING
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD   65535  // [mm/s]
  #define X2_HYBRID_THRESHOLD  65535
  #define Y_HYBRID_THRESHOLD   65535
  #define Y2_HYBRID_THRESHOLD  65535
  #define Z_HYBRID_THRESHOLD   65535
  #define Z2_HYBRID_THRESHOLD  65535
